...
function createDrawing(drawingOptions?: IDrawingOptions, hyperlinkOnClick?: HyperlinkRef): Drawing {
    return new Drawing(
        {
            fileName: "test.jpg",
...
function createExternalDrawing(drawingOptions?: IDrawingOptions, hyperlinkOnClick?: HyperlinkRef): Drawing {
    return new Drawing(
        {
            fileName: "external.jpg",
            data: "https://docx.js.org/external.jpg",
            dimensions: {
                pixels: {
                    x: 100,
                    y: 100,
...
describe("Drawing", () => {
    ...
    describe("#constructor()", () => {
        ...
        it("should create an external drawing with inline element when there are no options passed", () => {
            currentBreak = createExternalDrawing();
            const tree = new Formatter().format(currentBreak);
            expect(tree).to.deep.equal({
                "w:drawing": [
                    {
    ...
    describe("#hyperlinkOnClick()", () => {
        ...
        it("should create a drawing with anchor element with hyperlink on click", () => {
            currentBreak = createDrawing(
                {
                    floating: {
                        horizontalPosition: {

...
export class Inline extends XmlComponent {
    ...
    constructor(readonly mediaData: IMediaData, private readonly dimensions: IMediaDataDimensions, hyperlinkOnClick?: HyperlinkRef) {
        super("wp:inline");
        ...
        this.graphic = new Graphic(mediaData, dimensions.emus.x, dimensions.emus.y, hyperlinkOnClick);
